...
Once you have NextJS ready, the next step is to integrate Hanko. This integration with Next is achieved using "elements". Following the [official Hanko documentation](https://docs.hanko.io/quickstarts/fullstack/next), install the package with your preferred client—for example:

```
bun add @teamhanko/hanko-elements
# or: pnpm add / npm install / yarn add @teamhanko/hanko-elements
```
